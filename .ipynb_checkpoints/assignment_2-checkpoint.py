...
#Open the dataset to calculate the mean temperature between 1850-1900 and produce the map of the mean temperature at preindustrial levels. Make sure to change the path to your climate data folder  
